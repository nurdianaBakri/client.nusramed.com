...
class M_obat_ajax extends CI_Model { 


	var $table = 'get_obat';
	var $column_order = array('barcode','nama','nm_satuan','industri','kandungan','deskripsi', 'jenis_terapi', null); //set column field database for datatable orderable
	var $column_search = array('barcode','nama','nm_satuan','industri','kandungan','deskripsi'); //set column field database for datatable searchable 
