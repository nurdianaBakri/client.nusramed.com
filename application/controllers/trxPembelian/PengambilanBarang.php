...
*/
        ...
        {  
            $data= $this->db->query("SELECT satuan.nm_satuan, A.harga_jual, A.barcode, A.no_reg, A.no_batch, A.diskon_per_item, A.stok_awal, A.sisa_stok, A.tgl_exp, A.id_trx, A.qty, A.qty_verified, obat.nama from trx_penjualan_tmp A, obat, satuan WHERE no_faktur='".$no_faktur."' and A.barcode=obat.barcode and obat.kd_satuan=satuan.kd_satuan and (id_user_verifikasi='' or id_user_verifikasi is null)")->result_array();
        }
        else
        {
            $data= $this->db->query("SELECT satuan.nm_satuan, A.harga_jual, A.barcode, A.no_reg, A.no_batch, A.diskon_per_item, A.stok_awal, A.sisa_stok, A.tgl_exp, A.id_trx, A.qty, A.qty_verified, obat.nama from trx_penjualan_tmp A, obat, satuan WHERE no_faktur='".$no_faktur."' and A.barcode=obat.barcode and obat.kd_satuan=satuan.kd_satuan and (id_user_verifikasi!='' or id_user_verifikasi is not null)")->result_array();
        }   
