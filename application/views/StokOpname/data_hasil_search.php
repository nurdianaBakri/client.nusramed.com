                ...
                if ($obat->num_rows()>0) {
                    ...
                    ?> 
                        <tr>
                            ...
                            <td>
                                <input type="text" name="no_batch[]" value="<?= $items->no_batch; ?>" class="form-control"  size="6">
                            </td>
                            <td>  
                                 <?php
                                    ...
                                    $date_2 =  date('Y-m-d', $s);   
                                ?> 
                                <input type="date" name="tgl_exp[]" value="<?= $date_2; ?>" class="form-control" size="1" >
                            </td>   
                              <td> 
                                 <input type="hidden" name="sisa_stok[]"  value="<?= $items->sisa_stok_total ?>"  class="form-control" min="0" max="100">

                                <input type="text" name="stok_real[]" value="" class="form-control" min="0" size="1"  >
                            </td> 
